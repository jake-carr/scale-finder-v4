...
export const scales = [
  ...
  },
  {
    ...
    pattern: [1, 3, 1, 2, 1, 2],
    info:
      "Fifth mode of the harmonic minor scale. Frequently used in Arabic, Egyptian, Spanish & Indian raga music.",
  },
  {
  ...
  },
  {
    ...
    pattern: [1, 4, 1, 4],
    info:
      "A scale adapted from shamishen music. Occasionally used by rock & jazz guitarists in search of 'new' sounds.",
  },
  {
    name: "Indian Pentantonic",
    pattern: [4, 1, 2, 3],
    info:
      "Gapped Phrygian Dominant scale, omitting the 2nd and 6th. Play with slides and bends for Indian feel.",
  },
  {
    name: "Persian",
    pattern: [1, 3, 1, 1, 2, 3],
